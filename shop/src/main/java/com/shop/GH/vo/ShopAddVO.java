...
public class ShopAddVO {
	...
	public String toString() {
		return "ShopAddVO [C_NO=" + C_NO + ", C_NAME=" + C_NAME + ", PD_NO=" + PD_NO + ", PD_NAME=" + PD_NAME
				+ ", PD_CATEGORY_NO=" + PD_CATEGORY_NO + ", PD_PRICE=" + PD_PRICE + ", PD_IMG=" + PD_IMG
				+ ", PD_QUANTITY=" + PD_QUANTITY + ", PD_INFO=" + PD_INFO + ", PD_READCOUNT=" + PD_READCOUNT
				+ ", PD_REGDATE=" + PD_REGDATE + "]";
	}
