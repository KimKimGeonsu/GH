...
//	public List<Shop_COL_SIZE> getPRODUCT_COL_SIZE() {
//		return PRODUCT_COL_SIZE;
//	}
//	public void setPRODUCT_COL_SIZE(List<Shop_COL_SIZE> pRODUCT_COL_SIZE) {
//		PRODUCT_COL_SIZE = pRODUCT_COL_SIZE;
//	}
	...
	public String toString() {
		return "ShopVO [C_NO=" + C_NO + ", C_NAME=" + C_NAME + ", SC_NO=" + SC_NO + ", SC_NAME=" + SC_NAME
				...
				+ PD_IMG + ", PD_INFO=" + PD_INFO + ", PD_READCOUNT=" + PD_READCOUNT + ", PD_REGDATE=" + PD_REGDATE
				+ "]";
	}
